<template>
  <div class="personal-consult-detail-m">
    <div class="personal-consult-detail-main-m">
      <div class="detail-head">
        <h4><span>向</span><span class="name" @click.stop="gocard(ask.userid)">{{ ask.name }}</span><span>提出问题</span></h4>
...
<style lang='less'>
.personal-consult-detail-m {
  width: 100%;
  .personal-consult-detail-main-m {
    position: relative;
    .detail-head {
      width: 100%;
      height: 45px;
