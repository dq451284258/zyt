  ...
  <div class="regist-main">
    <div class="regist-main-head">
      <div class="mian-head-img">
        <img src="../assets/logo_fg.png" alt="">
      </div>
      <h4><span>想起密码，</span><router-link to="/login"><span class="login">马上登录</span></router-link><router-link to="/"><span class="home">返回首页</span></router-link></h4>
    </div>
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          this.$ajax.post('/user/forget',{
            ...
            if(res.data.code === 1) {
              this.$message({ message: '恭喜你，修改密码成功', type: 'success' });
              setTimeout(() => {
